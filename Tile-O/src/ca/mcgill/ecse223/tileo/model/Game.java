...
public class Game
{
  ...
  //Game State Machines
  public enum Mode { DESIGN, GAME, GAME_WON, GAME_ROLLDIEACTIONCARD, GAME_CONNECTTILESACTIONCARD, GAME_REMOVECONNECTIONACTIONCARD, GAME_TELEPORTACTIONCARD, GAME_LOSETURNACTIONCARD, GAME_WINTILEHINTACTIONCARD, GAME_NEXTPLAYERROLLSONEACTIONCARD, GAME_SETACTIONTILESINACTIVEACTIONCARD }
  private Mode mode;
